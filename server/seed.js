...
module.exports = {
    ...
    CREATE TABLE back_and_bi ( 
        ...
        deadlift VARCHAR(3000) NOT NULL, 
        bent_over_row VARCHAR(3000) NOT NULL, 
        pull_up VARCHAR(3000) NOT NULL, 
        seated_row VARCHAR(3000) NOT NULL, 
        barbell_curl VARCHAR(3000) NOT NULL, 
        chin_up VARCHAR(3000) NOT NULL, 
        hammer_curl VARCHAR(3000) NOT NULL, 
        incline_dumbbell_curl VARCHAR(3000) NOT NULL 
    ); 
    ...
    CREATE TABLE chest_and_tri ( 
        ...
        incline_push_up VARCHAR(3000) NOT NULL, 
        flat_bench_press VARCHAR(3000) NOT NULL, 
        decline_bench_press VARCHAR(3000) NOT NULL, 
        incline_bench_press VARCHAR(3000) NOT NULL, 
        bench_dips VARCHAR(3000) NOT NULL, 
        dumbbell_tricep_extension VARCHAR(3000) NOT NULL, 
        push_ups VARCHAR(3000) NOT NULL, 
        reverse_grip_bench_press VARCHAR(3000) NOT NULL     
    ); 

    CREATE TABLE shoulders ( 
        shoulders_id SERIAL PRIMARY KEY, 
        push_ups VARCHAR(3000) NOT NULL, 
        lateral_raise VARCHAR(3000) NOT NULL, 
        over_head_press VARCHAR(3000) NOT NULL, 
        standing_cable_pulley_fly VARCHAR(3000) NOT NULL 
    ); 

    insert into users (username, email, password, first_name, last_name)
    values ('cdog', 'colin@colin.com', 1234, 'colin', 'dorman');

    insert into shoulders (push_ups, lateral_raise, over_head_press, standing_cable_pulley_fly)
    values(
    ...
    insert into back_and_bi (deadlift, bent_over_row, pull_up, seated_row, barbell_curl, chin_up, hammer_curl, incline_dumbbell_curl)
    values (
    ...
    insert into chest_and_tri (incline_push_up, flat_bench_press, decline_bench_press,
        incline_bench_press, bench_dips, dumbbell_tricep_extension, push_ups, reverse_grip_bench_press )
    values (
    ...
    bending of the arms while keeping the back straight and supporting the body on the hands and toes.',
        'The reverse grip bench press is a barbell bench press variation that alternates the lifters grip and 
    ...
    insert into leg_day (back_squat, front_squat, romanian_deadlift, walking_lunges, reverse_lunge,
        lateral_lunge, step_up)
    values (
